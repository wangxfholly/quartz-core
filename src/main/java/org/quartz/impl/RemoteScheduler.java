 ...
 * <code>QuartzScheduler</code> instance, via RMI.
 * </p>
 * 
...
public class RemoteScheduler implements Scheduler {
    ...
    public SchedulerMetaData getMetaData() throws SchedulerException {
        try {
            ...
            return new SchedulerMetaData(getSchedulerName(),
                    ...
                    sched.supportsPersistence(), sched.isClustered(),
    ...
    public void scheduleJob(JobDetail jobDetail,
        ...
        try {
            getRemoteScheduler()
                    .scheduleJob(jobDetail, triggersForJob, replace);
        } catch (RemoteException re) {
            throw invalidateHandleCreateException(
                    "Error communicating with remote scheduler.", re);
        }
    ...
    public void addCalendar(String calName, Calendar calendar, boolean replace,
        ...
        try {
            getRemoteScheduler().addCalendar(calName, calendar, replace,
                    updateTriggers);
        } catch (RemoteException re) {
            throw invalidateHandleCreateException(
                    "Error communicating with remote scheduler.", re);
    ...
    /*
     * (非 Javadoc) <p>Title: addTrigger</p> <p>Description: </p>
     * 
     * @param trigger
     * 
     * @param replace
     ...
     * @throws SchedulerException
     * 
     * @see org.quartz.Scheduler#addTrigger(org.quartz.Trigger, boolean)
     */
    @Override

 ...
 * <code>{@link org.quartz.Scheduler}</code> interface, containing methods to
 * schedule <code>{@link org.quartz.Job}</code>s, register
...
public class QuartzScheduler implements RemotableQuartzScheduler {
    ...
    static {
        ...
        InputStream is = null;
        try {
            is = QuartzScheduler.class
                    .getResourceAsStream("quartz-build.properties");
            if (is != null) {
                props.load(is);
            ...
            (LoggerFactory.getLogger(QuartzScheduler.class)).error(
                    "Error loading version info from quartz-build.properties.",
                    e);
        } finally {
            if (is != null) {
                try {
    ...
    private HashMap<String, JobListener> internalJobListeners = new HashMap<String, JobListener>(
            10);

    private HashMap<String, TriggerListener> internalTriggerListeners = new HashMap<String, TriggerListener>(
            10);

    private ArrayList<SchedulerListener> internalSchedulerListeners = new ArrayList<SchedulerListener>(
            10);
        ...
        getLog().info(
                "Scheduler meta-data: "
                        + (new SchedulerMetaData(getSchedulerName(),
                                getSchedulerInstanceId(), getClass(),
                                boundRemotely, runningSince() != null,
                                isInStandbyMode(), isShutdown(),
                                runningSince(), numJobsExecuted(),
                                getJobStoreClass(), supportsPersistence(),
                                isClustered(), getThreadPoolClass(),
    ...
    private void unBind() throws RemoteException {
        ...
        Registry registry = LocateRegistry.getRegistry(
                resources.getRMIRegistryHost(), resources.getRMIRegistryPort());
     ...
     * <code>{@link org.quartz.Trigger}s</code>.
     * </p>
     * 
     * <p>
     * All <code>{@link org.quartz.Trigger}s</code> that have misfired will be
     * passed to the appropriate TriggerListener(s).
     * </p>
     */
     ...
     * <code>{@link org.quartz.Trigger}s</code>, and cleans up all resources
    ...
    public boolean isStarted() {
        return !shuttingDown && !closed && !isInStandbyMode()
                && initialStart != null;
    }
     ...
     * <code>{@link org.quartz.JobDetail}</code> to the Scheduler, and associate
     * the given <code>{@link org.quartz.Trigger}</code> with it.
     * </p>
     * 
     * <p>
        ...
        if (ft == null) {
            throw new SchedulerException(
                    "Based on configured schedule, the given trigger '"
                            + trigger.getKey() + "' will never fire.");
        }
    ...
    public Date scheduleJob(Trigger trigger) throws SchedulerException {
        ...
        if (trigger.getCalendarName() != null) {
            cal = resources.getJobStore().retrieveCalendar(
                    trigger.getCalendarName());
            if (cal == null) {
                throw new SchedulerException("Calendar not found: "
                        + trigger.getCalendarName());
            }
        }
        Date ft = trig.computeFirstFireTime(cal);
    ...
    public void addTrigger(Trigger trigger, boolean replace)
            throws SchedulerException {
        if (trigger == null) {
            throw new SchedulerException("Trigger cannot be null");
        }
        ...
        resources.getJobStore().storeTrigger(trig, replace);
    }
        ...
        for (Trigger trigger : triggers) {
            if (!unscheduleJob(trigger.getKey())) {
                StringBuilder sb = new StringBuilder()
                        ...
                        .append("] while deleting job [").append(jobKey)
                        .append("]");
    ...
    public void scheduleJobs(
        ...
        for (Entry<JobDetail, Set<? extends Trigger>> e : triggersAndJobs
                .entrySet()) {
            JobDetail job = e.getKey();
            if (job == null) // there can be one of these (for adding a bulk set
            // of triggers for pre-existing jobs)
                continue;
            Set<? extends Trigger> triggers = e.getValue();
            if (triggers == null) // this is possible because the job may be
            // durable, and not yet be having triggers
                continue;
            for (Trigger trigger : triggers) {
    ...
    public void triggerJob(JobKey jobKey, JobDataMap data)
        ...
        while (collision) {
            try {
                ...
                trig.setKey(new TriggerKey(newTriggerId(),
     ...
     * <code>{@link org.quartz.spi.OperableTrigger}</code>
     * </p>
     */
    ...
    public void pauseTriggers(GroupMatcher<TriggerKey> matcher)
        ...
        Collection<String> pausedGroups = resources.getJobStore()
                .pauseTriggers(matcher);
        notifySchedulerThread(0L);
    ...
    public void pauseJobs(GroupMatcher<JobKey> groupMatcher)
        ...
        Collection<String> pausedGroups = resources.getJobStore().pauseJobs(
                groupMatcher);
        notifySchedulerThread(0L);
        for (String pausedGroup : pausedGroups) {
    ...
    public void resumeJobs(GroupMatcher<JobKey> matcher)
        ...
        Collection<String> resumedGroups = resources.getJobStore().resumeJobs(
                matcher);
        notifySchedulerThread(0L);
    ...
    /**
     * <p>
     * Get the names of all the <code>{@link org.quartz.Trigger}s</code> in the
     * matching groups.
     * </p>
     */
    ...
    /**
     * Clears (deletes!) all scheduling data - all {@link Job}s, {@link Trigger}
     * s {@link Calendar}s.
     * 
     * @throws SchedulerException
     */
    ...
    public void addCalendar(String calName, Calendar calendar, boolean replace,
        ...
        resources.getJobStore().storeCalendar(calName, calendar, replace,
                updateTriggers);
    }
    ...
    /**
     * <p>
     * Remove the identified <code>{@link JobListener}</code> from the
     ...
     * <code>{@link org.quartz.JobListener}</code>s in the
     * <code>Scheduler</code>'s <i>internal</i> list.
     * </p>
     */
    public List<JobListener> getInternalJobListeners() {
        synchronized (internalJobListeners) {
            return java.util.Collections
                    .unmodifiableList(new LinkedList<JobListener>(
    ...
    /**
     * <p>
     * Get the <i>internal</i> <code>{@link org.quartz.JobListener}</code> that
     * has the given name.
     * </p>
     */
    ...
    public void addInternalTriggerListener(TriggerListener triggerListener) {
        ...
        synchronized (internalTriggerListeners) {
            internalTriggerListeners.put(triggerListener.getName(),
                    triggerListener);
        }
    }
     ...
     * <p>
     * Get a list containing all of the
     * <code>{@link org.quartz.TriggerListener}</code>s in the
     * <code>Scheduler</code>'s <i>internal</i> list.
     * </p>
     */
    public List<TriggerListener> getInternalTriggerListeners() {
        synchronized (internalTriggerListeners) {
            return java.util.Collections
                    .unmodifiableList(new LinkedList<TriggerListener>(
    ...
    /**
     * <p>
     * Get the <i>internal</i> <code>{@link TriggerListener}</code> that has the
     * given name.
     * </p>
     */
     ...
     * <code>{@link SchedulerListener}</code>s registered with the
     * <code>Scheduler</code>.
     * </p>
     */
    public List<SchedulerListener> getInternalSchedulerListeners() {
        synchronized (internalSchedulerListeners) {
            return java.util.Collections
                    .unmodifiableList(new ArrayList<SchedulerListener>(
                            internalSchedulerListeners));
        }
    }

    protected void notifyJobStoreJobComplete(OperableTrigger trigger,
            JobDetail detail, CompletedExecutionInstruction instCode) {
        resources.getJobStore().triggeredJobComplete(trigger, detail, instCode);
    }

    protected void notifyJobStoreJobVetoed(OperableTrigger trigger,
            JobDetail detail, CompletedExecutionInstruction instCode) {
        resources.getJobStore().triggeredJobComplete(trigger, detail, instCode);
    }
    ...
    private boolean matchJobListener(JobListener listener, JobKey key) {
        List<Matcher<JobKey>> matchers = getListenerManager()
                .getJobListenerMatchers(listener.getName());
        if (matchers == null)
            return true;
    ...
    private boolean matchTriggerListener(TriggerListener listener,
            TriggerKey key) {
        List<Matcher<TriggerKey>> matchers = getListenerManager()
                .getTriggerListenerMatchers(listener.getName());
        if (matchers == null)
            return true;
    ...
    public void notifySchedulerListenersError(String msg, SchedulerException se) {
        ...
        for (SchedulerListener sl : schedListeners) {
            try {
                ...
                getLog().error(
                        "Error while notifying SchedulerListener of error: ", e);
                getLog().error(
    ...
    private void shutdownPlugins() {
        java.util.Iterator<SchedulerPlugin> itr = resources
                .getSchedulerPlugins().iterator();
        while (itr.hasNext()) {
...
class ExecutingJobsManager implements JobListener {
    ...
    public void jobToBeExecuted(JobExecutionContext context) {
        ...
        synchronized (executingJobs) {
            executingJobs.put(((OperableTrigger) context.getTrigger())
                    .getFireInstanceId(), context);
        }
    }
    ...
    public void jobWasExecuted(JobExecutionContext context,
        ...
        synchronized (executingJobs) {
            executingJobs.remove(((OperableTrigger) context.getTrigger())
                    .getFireInstanceId());
        }
    }
    ...
    public List<JobExecutionContext> getExecutingJobs() {
        synchronized (executingJobs) {
            return java.util.Collections
                    .unmodifiableList(new ArrayList<JobExecutionContext>(
